...
local icons = require('minimal-statusline.icons')
...
local function get_diagnostic_info(level)
  ...
  local signs = {
    icons.diagnosticSigns[1].text,
    icons.diagnosticSigns[2].text,
    icons.diagnosticSigns[3].text,
    icons.diagnosticSigns[4].text,
  }
...
function providers.diagnostic()
  ...
  table.insert(sb, "%#" .. icons.diagnosticSigns[1].name .. "#")
  table.insert(sb, errors)

  table.insert(sb, "%#" .. icons.diagnosticSigns[2].name .. "#")
  table.insert(sb, warnings)

  table.insert(sb, "%#" .. icons.diagnosticSigns[3].name .. "#")
  table.insert(sb, hints)

  table.insert(sb, "%#" .. icons.diagnosticSigns[4].name .. "#")
